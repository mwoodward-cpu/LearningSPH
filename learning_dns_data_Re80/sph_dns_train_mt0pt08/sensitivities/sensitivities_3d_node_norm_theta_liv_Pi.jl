...
if restart=="true"
  params_path = "./round2/output_data_unif_tracers_forward_node_norm_theta_liv_Pi_lf_skl0_itr800_lr0.002_T30_θ0.0012_h0.335_tcoarse1_dt0.04_height6_mnode_norm_theta_liv_Pi_llf_klswitch0/params_fin.npy"
  p_hat = npzread(params_path)
end
if restart=="true2"
  params_path = "./exp1_outputs/output_data_unif_tracers_forward_node_norm_theta_liv_Pi_lf_itr800_lr0.002_T20_θ0.0012_h0.335_tcoarse1_dt0.04_height8_mnode_norm_theta_liv_Pi_llf_klswitch0/params_fin.npy"
  p_hat = npzread(params_path)
end
