...
#T = 20;
#n_itrs = 101;		#number of iteration
...
method = "phys_inf_Wliu_theta_po_liv_Pi"
	...
	for k ∈ 1 : n_itrs
        ...
        if mod(k, vis_rate) == 0
			...
			L_itr[ii] = L;
			   ...
			   β_itr[ii] = p_h[3]; g_itr[ii] = p_h[4]; θ_itr[ii] = p_h[6]; po_itr[ii] = p_h[5];
			   println("Itr  = ", k, "  c_hat = ", p_h[1],  "  α_hat = ", p_h[2], "  β_hat = ", p_h[3],
					 "  g_hat = ", p_h[4], "  θ_hat = ", p_h[5], "   $(loss_method): Loss = ", L)
