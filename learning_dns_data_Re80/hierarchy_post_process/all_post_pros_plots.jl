...
m_runs = "phys_inf"
include("./plotting_gen_errors_t20.jl")
...
#plot learned accl distributions for phys inf (over time)
m_kind = "phys"
include("./plotting_single_part_stats_nncomp_t20.jl")
