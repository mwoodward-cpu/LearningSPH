...
# for method in m_tot[5:9]
		...
		function load_data_t20(method, T_pred, T_train)
			...
			tra_path = "$(data_dir_phy)/traj_Tp$(T_pred)_Tt$(T_train)_h$(h)_dns_$(method)_$(l_method).npy"
			vel_path = "$(data_dir_phy)/vels_Tp$(T_pred)_Tt$(T_train)_h$(h)_dns_$(method)_$(l_method).npy"
			rho_path = "$(data_dir_phy)/rhos_Tp$(T_pred)_Tt$(T_train)_h$(h)_dns_$(method)_$(l_method).npy"
		...
		if gen_error_m == "over_t"
			Lt, Lgt, Lgkl_t, Lf_norm, Lkl_a, Lkl_d = obtain_gen_loss_t(20, T_pred, 20)
			save_output_data(Lt, "./learned_generalization/$(l_method)_loss_t_$(method)_Tp$(T_pred)_Tt$(T_train)_$(gen_error_m).npy")
			save_output_data(Lgt, "./learned_generalization/$(lg_method)_loss_t_$(method)_Tp$(T_pred)_Tt$(T_train)_$(gen_error_m).npy")
			save_output_data(Lgkl_t, "./learned_generalization/kl_t_loss_t_$(method)_Tp$(T_pred)_Tt$(T_train)_$(gen_error_m).npy")
			save_output_data(Lf_norm, "./learned_generalization/lf_norm_loss_t_$(method)_Tp$(T_pred)_Tt$(T_train)_$(gen_error_m).npy")
			save_output_data(Lkl_a, "./learned_generalization/kl_t_accl_$(method)_Tp$(T_pred)_Tt$(T_train)_$(gen_error_m).npy")
			save_output_data(Lkl_d, "./learned_generalization/kl_t_diff_$(method)_Tp$(T_pred)_Tt$(T_train)_$(gen_error_m).npy")
		end
		...
		if gen_error_m == "over_Mt"
			...
			save_output_data(Lt, "./learned_generalization_mt_rel/$(l_method)_loss_t_$(method)_T$(T_train)_$(gen_error_m).npy")
			# save_output_data(Lgt, "./learned_generalization_mt_rel/$(lg_method)_loss_t_$(method)_T$(T_train)_$(gen_error_m).npy")
			save_output_data(Lgkl_t, "./learned_generalization_mt_rel/kl_t_loss_t_$(method)_T$(T_train)_$(gen_error_m).npy")
			save_output_data(Lf_norm, "./learned_generalization_mt_rel/lf_norm_loss_t_$(method)_T$(T_train)_$(gen_error_m).npy")
