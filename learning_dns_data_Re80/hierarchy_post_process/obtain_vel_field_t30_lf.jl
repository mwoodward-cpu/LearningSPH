...
m_n = parse(Int, ARGS[1]);
	...
	function load_sim_coarse_data(method)
		acc_path = "./learned_data_t30_lf/accl_Tp$(T_pred)_Tt$(T_train)_h$(h)_$(IC)_$(method)_$(l_method).npy"
		tra_path = "./learned_data_t30_lf/traj_Tp$(T_pred)_Tt$(T_train)_h$(h)_$(IC)_$(method)_$(l_method).npy"
		vel_path = "./learned_data_t30_lf/vels_Tp$(T_pred)_Tt$(T_train)_h$(h)_$(IC)_$(method)_$(l_method).npy"
		rho_path = "./learned_data_t30_lf/rhos_Tp$(T_pred)_Tt$(T_train)_h$(h)_$(IC)_$(method)_$(l_method).npy"
	...
	make_dir("learned_field_data_t30_lf");
	...
	save_output_data(Vf_pr, "./learned_field_data_t30_lf/Vf_pr_$(method)_$(l_method)_Tp$(T_pred)_Tt$(T_train).npy")
#end
