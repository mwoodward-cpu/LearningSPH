...
function plot_kernels_2(a1, b1, a2, b2, h)
  # gr(size=(900,750))
  path = "./learned_figures_t50_lfklt/comp_W.png"
...
function plot_kernels_der_2(a1, b1, a2, b2, h)
  # gr(size=(900,750))
  path = "./learned_figures_t50_lfklt/comp_W_r.png"
...
function plot_kernels_H_2(a1, b1, a2, b2, h)
  # gr(size=(900,750))
  path = "./learned_figures_t50_lfklt/comp_H.png"
...
t_coarse = 1; dt = t_coarse * 0.04; l_method = "lf_klt"

include("load_models_t50_lfklt.jl")
