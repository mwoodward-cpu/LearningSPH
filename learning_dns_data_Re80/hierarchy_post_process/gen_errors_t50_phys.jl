...
function load_sim_coarse_data(method)
	acc_path = "./learned_data/accl_Tp$(T_pred)_Tt$(T_train)_h$(h)_$(IC)_$(method)_lf_klt.npy"
	tra_path = "./learned_data/traj_Tp$(T_pred)_Tt$(T_train)_h$(h)_$(IC)_$(method)_lf_klt.npy"
	vel_path = "./learned_data/vels_Tp$(T_pred)_Tt$(T_train)_h$(h)_$(IC)_$(method)_lf_klt.npy"
	rho_path = "./learned_data/rhos_Tp$(T_pred)_Tt$(T_train)_h$(h)_$(IC)_$(method)_lf_klt.npy"
...
make_dir("learned_field_data_t50");
...
save_output_data(Vf_gt, "./learned_field_data/Vf_gt_Tp500.npy")
...
# Lt, Lgt, Lgkl_t, Lf_norm = obtain_gen_loss_t(20, T_pred, 20)
save_output_data(Lt, "./learned_generalization/$(l_method)_loss_t_$(method)_Tp$(T_pred)_Tt$(T_train).npy")
save_output_data(Lgt, "./learned_generalization/$(lg_method)_loss_t_$(method)_Tp$(T_pred)_Tt$(T_train).npy")
save_output_data(Lgkl_t, "./learned_generalization/kl_t_loss_t_$(method)_Tp$(T_pred)_Tt$(T_train).npy")
save_output_data(Lf_norm, "./learned_generalization/lf_norm_loss_t_$(method)_Tp$(T_pred)_Tt$(T_train).npy")
