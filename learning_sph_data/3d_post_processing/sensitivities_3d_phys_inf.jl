        ...
        for za_hash in x_hash[3] - 2 : x_hash[3] + 2
          ...
          for n2 in hash[xb_hash, yb_hash, zb_hash]
            ...
            if (close)
              ...
              ∂F_p[n, 4, :] .+= ∂fij_p(n, n2, rho, XX, VV, r2, p_in, h, m, 1)
              ∂F_p[n, 5, :] .+= ∂fij_p(n, n2, rho, XX, VV, r2, p_in, h, m, 2)
              ∂F_p[n, 6, :] .+= ∂fij_p(n, n2, rho, XX, VV, r2, p_in, h, m, 3)
              ...
              dP_rhz = (∂P_rhoi2_∂z(rho[n], drhoi_dxi[n, 3], c_in, g_in) + ∂P_rhoi2_∂z(rho[n2], drhoj_dxi[n2, 3], c_in, g_in))
