      ...
      for ya_hash in x_hash[2] - 2 : x_hash[2] + 2
        ...
        for n2 in hash[xb_hash, yb_hash]
          ...
          if (close)
              ...
              ∂F_p[n, 3, :] .+= - m * ∂f_θ * tmpH * XX[1];
              ∂F_p[n, 4, :] .+= - m * ∂f_θ * tmpH * XX[2];
              ...
              #∂ₓF^x:
              ∂F_x[n, 3, 1] += - (XX[1]^2)*(m*Π + nn_p_rho)*tmp∂rH_r - m*XX[1]*(∂Π_∂xi + ∂Prhonn_∂x)*tmpH - (m*Π + nn_p_rho)*tmpH
              #∂yF^x:
              ∂F_x[n, 3, 2] += - (XX[1]*XX[2])*(m*Π + nn_p_rho)*tmp∂rH_r - m*XX[1]*(∂Π_∂yi + ∂Prhonn_∂y)*tmpH
              #∂uF^x:
              ...
              #∂ₓF^y:
              ∂F_x[n, 4, 1] += - (XX[1]*XX[2])*(m*Π + nn_p_rho)*tmp∂rH_r - m*XX[2]*(∂Π_∂xi + ∂Prhonn_∂x)*tmpH
              #∂yF^y:
              ∂F_x[n, 4, 2] += - (XX[2]^2)*(m*Π + nn_p_rho)*tmp∂rH_r - m*XX[2]*(∂Π_∂yi + ∂Prhonn_∂y)*tmpH - (m*Π + nn_p_rho)*tmpH
              #∂uF^y:
