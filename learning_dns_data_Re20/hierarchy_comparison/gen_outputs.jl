...
file_title = "itr$(n_itrs)_lr$(lr)_T$(T)_θ$(θ)_h$(h)_tcoarse$(t_coarse)_dt$(dt)_height$(height)_m$(method)_l$(loss_method)"
...
if (method != "phys_inf" && method != "phys_inf_Wab" && method != "phys_inf_theta" && method != "phys_inf_Wab_bg_pres" &&
    method != "phys_inf_Wab_po" && method != "phys_inf_W2ab_bgp" && method != "phys_inf_W2ab_po" &&
	method != "phys_inf_Wliu" && method != "phys_inf_W2ab")
