        ...
        for za_hash in x_hash[3] - 2 : x_hash[3] + 2
          ...
          for n2 in hash[xb_hash, yb_hash, zb_hash]
            ...
            if (close)
              ...
              ∂f_θ = ∂f_∂θk(feature_ij, pnn_in);

              ∂F_p[n, 4, 1:(end-1)] .+= ∂f_θ*XX[1]
              ∂F_p[n, 5, 1:(end-1)] .+= ∂f_θ*XX[2]
              ∂F_p[n, 6, 1:(end-1)] .+= ∂f_θ*XX[3]
