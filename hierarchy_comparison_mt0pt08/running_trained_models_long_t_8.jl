...
m_nns = ["node_norm_theta_liv_Pi", "nnsum2_norm_theta_liv_Pi", "rot_inv_theta_liv_Pi",
		 "grad_p_theta_alpha_beta_liv_Pi"];
l_m = ["lf", "kl_lf_t", "l2"];
...
#output_data_unif_tracers_forward_grad_p_theta_alpha_beta_liv_Pi_lf_itr500_lr0.02_T30_θ0.0009_h0.335_tcoarse2_dt0.04_height6_mgrad_p_theta_alpha_beta_liv_Pi_llf_klswitch0
