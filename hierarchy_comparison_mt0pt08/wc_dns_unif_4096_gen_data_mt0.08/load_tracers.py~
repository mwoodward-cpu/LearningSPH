...
u=np.fromfile('./vel_traj_filter4_4096_mesh.bin')
x=np.fromfile('./pos_traj_filter4_4096_mesh.bin')
r=np.fromfile('./rho_traj_filter4_4096_mesh.bin')
p=np.fromfile('./p_traj_filter4_4096_mesh.bin')
