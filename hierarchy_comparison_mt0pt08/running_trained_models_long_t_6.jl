...
m_nns = ["node_norm_theta_liv_Pi", "nnsum2_norm_theta_liv_Pi"];
l_m = ["lf", "kl_lf_t", "l2"];
...
height = 6;
class = "nnsum";
# output_data_unif_tracers_forward_nnsum2_norm_theta_liv_Pi_lf_itr500_lr0.005_T30_θ0.0012_h0.335_tcoarse2_dt0.04_height6_mnnsum2_norm_theta_liv_Pi_llf_klswitch0
